...
CPPLINT_FILTER="-build/include,+build/include_order,+build/include_what_you_use,-whitespace/line_length,-whitespace/braces,-whitespace/newline,-readability/streams"
