...
function eclipse {
  ...
  cmake "$GAMESERVER_DIR" -G"Eclipse CDT4 - Unix Makefiles" -DCMAKE_BUILD_TYPE=debug -DGAMESERVER_USE_ASAN=ON -DCMAKE_ECLIPSE_VERSION=4.7.3 -DCMAKE_CXX_COMPILER_ARG1=-std=c++14
  ln -sf "$DATA_DIR" data
  popd
}
